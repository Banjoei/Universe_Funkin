...
## Requirements
1. The ability to compile The Universe Funkin' from the source code. All information related to building The Universe Funkin' is listed [here.](https://kadedev.github.io/Kade-Engine/building)
2. A text editor. Some form of IDE that can support Haxe is recommended, such as Visual Studio Code.

---
### Step 1. Navigation
Navigate to your The Universe Funkin' source code. In the `source` folder, look for `StoryMenuState.hx`. Open it in your text editor.
